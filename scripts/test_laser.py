...
def test_with_laser(net, cfg, laser_path):
    ...
    '''
        ...
        plt.savefig('../preds/pred_plot.png', bbox_inches='tight')
    '''
    pimg.imsave('../preds/laser_pred.png', pred_img)
    # showPredImg(pred_img)
    #np.save('../preds/laser_pred.npy', pred_img)
...
def main():
    ...
    model_ckp_name = "../logs/dataset_newnew/laser/model.chk-50"
    ...
    test_path = "/data/tmp/hl_data/validation/laser/test/all/"
    ...
    #nr = laser_images.index(test_path+'bag6_depth_labeled160.npy')
    #laser_input = laser_images[nr]
    #test_with_laser(net, cfg, laser_input)
    start = time.time()
    iterations = 100
